...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'form-layouts', name: 'form-layouts', component: () => import('@/pages/form-layouts/FormLayoutIndex.vue') },
            { path: 'form-layouts/new', name: 'form-layout-new', component: () => import('@/pages/form-layouts/FormLayoutPage.vue'), meta: { fullBleed: true } },
            { path: 'form-layouts/:id/edit', name: 'form-layout-edit', component: () => import('@/pages/form-layouts/FormLayoutPage.vue'), meta: { fullBleed: true } },
            { path: 'form-layouts/:id', name: 'form-layout-view', component: () => import('@/pages/form-layouts/FormLayoutView.vue') },
